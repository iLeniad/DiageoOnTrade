...
class VisibilidadController: UIViewController,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    var aux_string = "[{\"id_elemento\":\"21\",\"tipo\":\"CABECERA\",\"query\":\"1\",\"color_renglon\":\"ffffff\",\"color_texto0\":\"FFFFFF\",\"color_texto1\":\"FFFFFF\",\"columna_filtro1\":\"brand\",\"columna_filtro2\":\"category\",\"columna_filtro3\":\"subcategory\"},{\"id_elemento\":\"22\",\"tipo\":\"SELECT_ONE_SPINNER\",\"texto\":\"Seleccione tipo de Visibilidad\",\"cuadro\":\"0\",\"ancho\":\"3\",\"linea\":\"0\",\"columna\":\"idItemRelation\",\"tabla\":\"mv_type\",\"valor\":\"value\",\"color_menu\":\"ffffff\",\"color_texto\":\"c60652\",\"id_padre\":\"idItemRelation\"},{\"id_elemento\":\"2\",\"tipo\":\"SELECT_ONE_SPINNER\",\"texto\":\"Fabricante\",\"cuadro\":\"0\",\"ancho\":\"3\",\"linea\":\"0\",\"columna\":\"idItemRelation\",\"tabla\":\"mpr_manufacturer\",\"valor\":\"value\",\"color_menu\":\"ffffff\",\"color_texto\":\"c60652\",\"id_padre\":\"idItemRelation\",\"query\":\"select * from mv_manufacturer\",\"elemento_hijo\":\"3\",\"valor_final\":\"no\"},{\"id_elemento\":\"3\",\"tipo\":\"SELECT_ONE_SPINNER\",\"texto\":\"Categoria\",\"cuadro\":\"0\",\"ancho\":\"3\",\"linea\":\"0\",\"columna\":\"idItemRelation\",\"tabla\":\"mpr_category\",\"valor\":\"value\",\"color_menu\":\"ffffff\",\"color_texto\":\"c60652\",\"id_padre\":\"idItemRelation\",\"elemento_padre\":\"2\",\"query\":\"select * from mv_category t where t.idManufacturer = '$padre$'\",\"elemento_hijo\":\"4\",\"valor_final\":\"no\"},{\"id_elemento\":\"4\",\"tipo\":\"LISTA_DOBLE\",\"texto\":\"Marca\",\"cuadro\":\"2\",\"ancho\":\"3\",\"linea\":\"26\",\"columna\":\"idItemRelation\",\"tabla\":\"mpr_brand\",\"valor\":\"value\",\"color_menu\":\"ffffff\",\"color_texto\":\"000000\",\"id_padre\":\"idItemRelation\",\"elemento_padre\":\"3\",\"query\":\"select * from mv_brand t where t.idCategory='$padre$'\",\"valor_final\":\"si\",\"tabla_guardar\":\"report_visibility_brands\",\"columna_guardar\":\"id_marca\",\"columna_guardar_padre\":\"id_report_distribution\",\"tabla_padre\":\"report_distribution\",\"id_padre_reporte\":\"id_item\"},{\"id_elemento\":\"24\",\"tipo\":\"FOTO\",\"cuadro\":\"7\",\"ancho\":\"1\",\"linea\":\"0\",\"columna\":\"id\",\"tabla\":\"report_photo_promotions\",\"total\":\"4\",\"id_padre_fk\":\"id_report_promotion\",\"tabla_padre\":\"report_visibility\",\"id_padre\":\"id\"},{\"id_elemento\":\"25\",\"tipo\":\"GUARDAR\",\"texto\":\"GUARDAR\",\"cuadro\":\"6\",\"ancho\":\"3\",\"linea\":\"1\",\"columna\":\"id_\",\"tabla\":\"mv_visibility\"}]"
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        textoSubTitulo.setTitle("Agregar Visibilidad", for: UIControlState())
    ...
    @objc func regresar(sender:UIButton){
        ...
        if tipoEstatus || fotoEstatus || marcasEstatus {
            ...
            let okAction = UIAlertAction(title: "Aceptar", style: UIAlertActionStyle.default) {
                ...
                self.performSegue(withIdentifier: "visibilidadtolistavisibilidad", sender: self)
        ...
        for renglon in lista {
            ...
            for elemento_lista in elementos_estructura {
                ...
                case "SELECT_ONE_SPINNER":
                    ...
                    //aux_b_select_menu.tag = Int(elementos_lista[elementos_lista.count - 1]["id_elemento"] as! String)!
                    
                    aux_b_select_menu.addTarget(self, action:#selector(VisibilidadController.mostrar_select_menu(sender:)), for:.touchDown)
                ...
                case "SUBESTRUCTURA":
                    ...
                    aux_boton.addTarget(self, action:#selector(VisibilidadController.mostrar_subestructura(sender:)), for:.touchDown)
                    ...
                    aux_boton_ojo.addTarget(self, action:#selector(VisibilidadController.mostrar_elementos_subestructura(sender:)), for:.touchDown)
                ...
                case "GUARDAR":
                    ...
                    aux_b_guardar.addTarget(self, action:#selector(VisibilidadController.guardar_reporte(sender:)), for:.touchDown)
    ...
    func crear_estructura(estructura:JSON,offset_y:Int,offset:Int) -> [String:AnyObject]{
        ...
        for k in 0 ..< estructura.arreglo.count {
            ...
            case "SELECT_ONE_SPINNER":
                ...
                estructura_elementos[estructura_elementos.count - 1]["color_texto"]=estructura.arreglo[k]["color@objc @objc @objc @objc @objc @objc @objc @objc @objc _texto@objc @objc "]
                estructura_elementos[estructura_elementos.count - 1]["id_padre"]=estructura.arreglo[k]["id_padre"]
            ...
            case "GUARDAR":
                ...
                botonGuardar.addTarget(self, action:#selector(VisibilidadController.guardar_reporte(sender:)), for:.touchDown)
                
                
                
                
                botonGuardar.setBackgroundImage(UIImage(named: "BotonGuardarVisibilidad"), for: .normal)
    ...
    @objc func mostrar_select_menu(sender:UIButton){
        ...
        for opcion in aux_opciones {
            ...
            if existente {
                ...
                boton.addTarget(self, action:#selector(VisibilidadController.opcion_select_menu(sender:)), for:.touchDown)
    ...
    @objc func seleccionar_lista_doble(sender:dobleListaButton){
        ...
        for elemento in elementos_lista where elemento["tipo"] as! String == "LISTA_DOBLE" {
            ...
            if offset != -99990 {
                ...
                //offset += sender.fr@objc ame.height
            ...
            if q == 0 {
                ...
                botonx.addTarget(self, action:#selector(VisibilidadController.remover_lista_doble(sender:)), for:.touchDown)
    ...
    @objc func remover_lista_doble(sender:dobleListaButton){
        ...
        let subvistas = auxVista.subviews
    ...
    @objc func opcion_select_menu(sender:UIButton){
        ...
        for opcion in aux_opciones {
            ...
            if sender.titleLabel!.text! == (opcion["opcion"] as! String).uppercased() {
                ...
                if elementos_lista[sender.tag]["id_elemento"] as! String == "2" {
                
                    auxIdFabricante = id_seleccion
                }
                ...
                if sender.titleLabel!.text == "OTRO" {
                    ...
                    let alert = UIAlertController(title: "Atención!", message: "Tipo de visibilidad", preferredStyle: .alert)
            ...
            case "LISTA_DOBLE":
                ...
                if segundo_hijo == 0 {
                    ...
                    for opcion in resultado_opciones {
                        ...
                        boton.idFabricante = auxIdFabricante
                        ...
                        boton.addTarget(self, action:#selector(VisibilidadController.seleccionar_lista_doble(sender:)), for:.touchDown)
    ...
    @objc func mostrar_subestructura(sender:UIButton)  {
        ...
        b_agregar.addTarget(self, action:#selector(VisibilidadController.agregar_subestructura(sender:)), for:.touchDown)
        ...
        b_cerrar.addTarget(self, action:#selector(VisibilidadController.cerrar_subestructura(sender:)), for:.touchDown)
    ...
    @objc func mostrar_elementos_subestructura(sender:UIButton){
        ...
        for elemento in aux_elementos {
            ...
            botonBorrar.addTarget(self, action:#selector(VisibilidadController.borrar_elemento_subestructura(sender:)), for:.touchDown)
        ...
        b_cerrar.frame = CGRect(x: 0, y: offset, width: subestructuraElementos.frame.width - 10, height: 50)
        ...
        b_cerrar.addTarget(self, action:#selector(VisibilidadController.ocultar_subestructura(sender:)), for:.touchDown)
    ...
    @objc func guardar_reporte(sender:UIButton){
        ...
        for aux_elemento in elementos_lista {
            ...
            case "SUBESTRUCTURA":
                ...
                for auxElementoNuevo in elementos_nuevos {
                    ...
                    for auxOpcionSeleccionada in opcionesSeleccionadas {
                        if k == 0 {
                           idFabricante = auxOpcionSeleccionada["id"] as! Int
                        }
                    ...
                    arregloMarcas.append(["idMarca":auxElementoNuevo["id"]!,"id_category":idCategoria as AnyObject,"id_manufacturer":idFabricante as AnyObject])
            ...
            case "LISTA_DOBLE":
                ...
                for subvista in subvistas where subvista is dobleListaButton {
                    ...
                    arregloMarcas.append(["idMarca":(subvista as! dobleListaButton).id as AnyObject,"id_category":(subvista as! dobleListaButton).categoriaId as AnyObject,"id_manufacturer":(subvista as! dobleListaButton).idFabricante as AnyObject])
        ...
        sql = "insert into report_visibility (id_report_local,id_category,id_brand,id_type,hash,is_send,other) values ('\(idReporteLocal!)','\(idCategoria)','\(idMarca)','\(idTipo)','','0','\(otroFinal)')"
        
        print(sql)
        
        _ = db.execute_query(sql)
        
        let resultado_report_visibilidad = db.select_query_columns("select * from report_visibility order by id desc limit 1")
        
        //print(resultado_report_promotion)
        
        for renglon in resultado_report_visibilidad {
            
            defaults.set(renglon["id"]!, forKey: "idReportVisibilidad")
            
            
        }
        
        var el_hash=String(tiempo_milisegundos) + String(describing: defaults.object(forKey: "idReportVisibilidad")!) + String(random)
        
        let idReportVisibilidad = defaults.object(forKey: "idReportVisibilidad")
        
        sql = "update report_visibility set hash='\(el_hash.md5())' where id='\(idReportVisibilidad!)'"
        ...
        for foto in auxFotos {
            ...
            let el_hashFoto=String(tiempo_milisegundos) + String(describing: defaults.object(forKey: "idReportVisibilidad")!) + String(random)
            
            sql = "insert into report_photo_visibility (id_report_local,id_report_visibility,path,hash,is_send,idReportServer) values ('\(idReporteLocal!)','\(idReportVisibilidad!)','\(foto["ruta"] as! String)','\(el_hashFoto.md5())','0','0')"
        ...
        for marca in arregloMarcas {
            ...
            print(marca["id_category"] as Any)
            print(marca["idMarca"] as Any)
            print(marca["id_manufacturer"] as Any)
            
            sql = "insert into report_visibility_brands (id_report_local,id_report_visibility,id_brand,id_category,hash,is_send,id_manufacturer) values ('\(idReporteLocal!)','\(idReportVisibilidad!)','\(marca["idMarca"] as! Int)','\(marca["id_category"] as! Int)','\(el_hash.md5())',0,'\(marca["id_manufacturer"] as! Int)')"
        ...
        defaults.set(1, forKey: "VisibilidadCompleta")
    ...
    func crear_acomodar_elemento(VistaScroll:UIScrollView,offset_lista:Int,tipo:String,elemento:AnyObject,indice:Int,id:NSNumber,estructura_y:Int,categoria_foto:String?=nil,auxElemento:AnyObject?=nil){
        ...
        case "SELECT_ONE_SPINNER":
            ...
            nuevo_elemento["color_texto"]="c60652" as AnyObject?
            nuevo_elemento["id_elemento"]=aux_elemento["id_elemento"] as! String as AnyObject?
            nuevo_elemento["id_padre"]=aux_elemento["id_padre"] as! String as AnyObject?
