...
class PromocionesController: UIViewController,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    var aux_string = "[{\"id_elemento\": \"1\",\"tipo\": \"CABECERA\",\"query\": \"select t1.id,t2.value as categoria,t3.value as marca,t4.value as tipo from report_promotions t1, mpr_category t2, mpr_brand t3, mpr_type t4, report_promtions_brands t5 where t5.id_category=t2.idItemRelation and t5.id_brand=t3.idItemRelation and t1.id_type_promotion=t4.idItemRelation and t5.id_report_promotion = t1.id and t1.id_report_local = '@idReporteLocal' group by t1.id\",\"color_renglon\": \"EEEEEE\",\"color_texto0\": \"999999\",\"color_texto1\": \"999999\",\"columna_filtro1\": \"brand\",\"columna_filtro2\": \"category\",\"columna_filtro3\": \"subcategory\"}, {\"id_elemento\": \"2\",\"tipo\": \"LABEL\",\"texto\": \"Esta es la label\",\"cuadro\": \"1\",\"ancho\": \"3\",\"linea\": \"3\",\"tamano\": \"20\",\"columna\": \"tipo\",\"prefijo\": \"PROMOCIÓN:\",\"color_prefijo\": \"c60652\",\"mayuscula\":\"1\"}, {\"id_elemento\": \"2\",\"tipo\": \"AGREGAR\",\"texto\": \"AGREGAR\",\"cuadro\": \"1\",\"ancho\": \"6\",\"linea\": \"1\",\"tamano\": \"20\",\"columna\": \"tipo\"}]"
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        textoSubTitulo.setTitle("Promociones", for: UIControlState())
    ...
    @objc func regresar(sender:UIButton){
        ...
        self.performSegue(withIdentifier: "promociontomodulos", sender: self)
            ...
            for elemento_lista in elementos_estructura {
                ...
                case "SELECT_ONE_RADIO":
                    ...
                    for boton in respuesta_nuevo_elemento["elemento"]!["botones"] as! [[String:AnyObject]] {
                        ...
                        aux_boton.addTarget(self, action:#selector(PromocionesController.b_radio_opcion(sender:)), for:.touchDown)
                ...
                case "FOTO":
                    ...
                    aux_b_foto.addTarget(self, action:#selector(PromocionesController.tomar_foto(sender:)), for:.touchDown)
        ...
        for k in 0 ..< estructura.arreglo.count {
            ...
            case "SELECT_ONE_RADIO":
                ...
                for boton in aux_elemento["botones"] as! [UIButton] {
                    ...
                    boton.addTarget(self, action:#selector(PromocionesController.b_radio_opcion(sender:)), for:.touchDown)
            ...
            case "FILTRO":
                ...
                aux_boton_filtro.addTarget(self, action:#selector(PromocionesController.mostrar_filtro(sender:)), for:.touchDown)
            ...
            case "AGREGAR":
                ...
                aux_boton_agregar.setBackgroundImage(UIImage(named:"BotonAgregarPromocion"), for: .normal)
    ...
    @objc func agregar_promocion(sender:UIButton){
        ...
        self.performSegue(withIdentifier: "promocionestopromocion", sender: self)
